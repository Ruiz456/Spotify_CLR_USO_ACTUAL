...
// ============================================================
// PARA QUE CUANDO SE PRESIONE UN BOTON(texto) se pueda escribir
// ============================================================
string presionarBotonYEscribir(HANDLE hIn, int x, int y)
{
    string texto = "";
    ...
    while (true)
    {
        INPUT_RECORD input;
        DWORD leidos;
        ReadConsoleInput(hIn, &input, 1, &leidos);
        ...
        string display = texto + "_";
        Console::Write(gcnew String(display.c_str()));
        // Limpiar sobrante
        for (int i = (int)display.length(); i < 48; i++)
            Console::Write(" ");
        Console::ResetColor();
    }
...
int main() {
    ...
    if (true)
    {
        ...
        while (true)
        {
            ...
            if (accion == 99)
            {
                ...
                // Activa escritura en posicion (70, 2)
                string textoBuscado = presionarBotonYEscribir(hIn, 71, 2);
    ...
    /// USAR SI ES NECESARIO EL CODIGO
    // --------------------------------------------------------
    //                 CODIGO DE Josselyn
    // --------------------------------------------------------
    /*
    ...
    MenuPrincipal(gestor, usuarioActual);
